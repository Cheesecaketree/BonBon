    ...
    <main class="app-shell static-landing">
      <header class="topbar">
        ...
        <div class="topbar-actions">
          <a class="topbar-github-link" href="https://github.com/Cheesecaketree/BonBon" target="_blank" rel="noopener noreferrer" title="GitHub-Repository" aria-label="GitHub-Repository">
      ...
      <footer class="site-footer">
        <div class="footer-container">
          <div class="footer-brand">
            <a class="footer-wordmark" href="/"><span>Bon</span><span>Bon</span></a>
            <p class="footer-tagline">100 % lokal · Open Source · Ohne Cloud</p>
            <p class="footer-license">0BSD-Lizenz · Frei zur beliebigen Nutzung</p>
          </div>
          <nav class="footer-nav" aria-label="Über BonBon">
            <ul class="footer-links">
              <li><a href="https://github.com/Cheesecaketree/BonBon" target="_blank" rel="noopener noreferrer">GitHub ↗</a></li>
            </ul>
          </nav>
        </div>
      </footer>
