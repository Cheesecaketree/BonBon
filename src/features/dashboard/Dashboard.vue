...
<section class="dashboard">
  ...
  <section v-else-if="activeView==='money'" id="dashboard-panel-money" role="tabpanel" aria-labelledby="dashboard-tab-money" class="chart-grid">
    ...
    <ChartCard :title="t('monthlySpendComparison')" :option="monthlyOption" :scrollable="isMobile && isAllYears" scroll-min-width="560px" :scroll-hint="t('scrollTimelineHint')"/>
